...
public class Column {
	 ...
	 * @return
	 */
	public String getFirstLetterLowerOtherUpperCase(){		
		String temp= StringHelper.makeAllWordFirstLetterUpperCase(getColumnName());
		return StringHelper.uncapitalize(temp);
	}
